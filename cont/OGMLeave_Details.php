...
<head>
		<title> OGM's Leave Details </title>
	</head>
			...
			<section class="main_frame">
				...
				<form action="../functions/manipulate.php" method="POST">
					<table class="foot" border="0">
						...
						<tr>
							<td>
								<input type="submit" class="btn btn-sm btn-primary" value="Approved" name="ogmLeaveApproval">
							</td>
							<td>
								<input type="submit" class="btn btn-sm btn-danger" value="Rejected" name="ogmLeaveReject">
							</td>
							<td class="text-right">
								<label> Remarks : </label>
							</td>
